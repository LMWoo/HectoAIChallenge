...
### 4. 대회 후기
 ...
 - 실험 종류가 많아지고 복잡해지면서, 코드도 복잡해지고 이전 실험에서 사용했던 파라미터들을 체계적으로 관리할 필요성을 절실히 느낌
   - 이를 해결하기 위해 pytorch lightning 및 hydra를 도입하여 복잡한 코드 간소화와 config기반 실험 관리 체계를 도입하여 실험할 예정
